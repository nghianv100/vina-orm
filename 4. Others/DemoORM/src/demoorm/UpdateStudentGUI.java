...
public class UpdateStudentGUI extends javax.swing.JDialog {
    ...
    public UpdateStudentGUI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    
    public UpdateStudentGUI(java.awt.Frame parent, boolean modal, Student student) {
        this(parent, modal);
        this.student = student;
        this.setTitle(student.getStudentName());
        
        txtClass.setText(student.getStudentClass());
        txtGPA.setText(String.valueOf(student.getStudentGPA()));
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cập nhật thông tin Học sinh");
        ...
        jPanel3.add(txtClass, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.insets = new java.awt.Insets(0, 0, 10, 0);
        jPanel3.add(txtGPA, gridBagConstraints);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            ...
            temp.setStudentId(txtId.getText());
            temp.setStudentClass(txtClass.getText());
            temp.setStudentGPA(Float.valueOf(txtGPA.getText()));
            temp.setStudentName(txtName.getText());
            conn.update(temp, String.format("id_student = '%s'", student.getStudentId()));
            conn.close();
        } catch (Exception ex) {
            ex.printStackTrace();
        } finally {
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            ...
            MySQLConnection conn = builder.setHost(host).setPort(port).setDbName(dbname).setUsername(username).setPassword(password).build();
            conn.open();
            conn.delete("student", String.format("id_student = '%s'", student.getStudentId()));
            conn.close();
        } catch (Exception ex) {
            ex.printStackTrace();
        } finally {
